...
export const ProjectButtons = ({changeFilter, currentFilter}) => {
    ...
    return <div className="filter flex relative justify-center space-x-3">
        ...
        <button className={"btn btn-primary btn-outline" + (currentFilter == "js" ? 'btn-active' : '')} onClick={() => swapFilter("js")}>
        <svg viewBox="0 0 128 128" className="size-[2em]">
        ...
        <button className={"btn btn-primary btn-outline" + (currentFilter == "python" ? 'btn-active' : '')} onClick={() => swapFilter("python")}>
        <svg viewBox="0 0 128 128" className="size-[2em]">
